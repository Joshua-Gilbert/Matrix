...
namespace Matrix_Multiply
{
    class ConsoleTable
    {
...

        {
           ...
           /* public void Write(Format format = ConsoleTable.Format.Default)

            {
...

                {
                    ...
                    case ConsoleTable.Format.Default:

                        Options.OutputTo.WriteLine(ToString());

                        break;

                    case ConsoleTable.Format.MarkDown:

                        Options.OutputTo.WriteLine(ToMarkDownString());

                        break;

                    case ConsoleTable.Format.Alternative:

                        Options.OutputTo.WriteLine(ToStringAlternative());

                        break;

                    case ConsoleTable.Format.Minimal:
